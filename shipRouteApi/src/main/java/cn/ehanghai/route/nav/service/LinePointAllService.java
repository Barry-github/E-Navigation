...
import cn.ehanghai.route.nav.domain.LinePointAll;
import cn.ehanghai.route.nav.mapper.LinePointAllMapper;
...
//        }
    ...
    public List<LinePointAll> getAreaPoints(String areaCode)
    {
