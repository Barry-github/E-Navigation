 ...
 * 航线段存储表
 */
@Table(name = "nav_t_base_line_test")
public class BaseLine extends BaseDomain {
    ...
    public  BaseLineAll toBaseLineAll()
    {
         return new BaseLineAll( name,  type,  startCode,  startLinePoint,  endLinePoint,  endCode,  distance,  remark,  importState,  draught,  high,  tonnage,  childNode,  oneWayStreet,  waterwayWidth,  lane,  valid);
    }
