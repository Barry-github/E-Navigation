 ...
 * @version 创建时间：2017年7月21日 上午9:03:07
 * 转折点实体类
 */
@Table(name = "nav_t_line_point_test")
public class LinePoint extends BaseDomain {
    ...
    public LinePoint(String code, String name, String enName, Float lon, Float lat, Integer needBroadcast, String remark, Integer importState, boolean harbour, boolean isolated, String geohash, Integer valid)
    {
        this.code = code;
        this.name = name;
        this.enName = enName;
    ...
    public LinePointAll toLinePointAll()
    {
        return new  LinePointAll( code,  name,  enName,  lon,  lat,  needBroadcast,  remark,  importState,  harbour,  isolated,  geohash,  valid);
    }
