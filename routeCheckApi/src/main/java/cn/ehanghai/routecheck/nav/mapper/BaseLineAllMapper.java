...
public interface BaseLineAllMapper extends Mapper<BaseLineAll>,InsertListMapper<BaseLineAll> {
    ...
    @Select("SELECT * from nav_t_base_line_all_test WHERE draught=-9999.0")
    @ResultMap("baselineallmap")
    List<BaseLineAll> getNoDepths();

    @Delete("delete from  nav_t_base_line_all_test  where  draught=-9999.0")
    void deleteNodepth();
